      ...
      containers: [
        {
          ...
          env: [
            ...
            { name: 'DISCORD_BOT_API_URL', value: 'http://${botAppName}.internal.${environmentDefaultDomain}' }
      ...
      containers: [
        {
          ...
          env: [
            ...
            { name: 'API_UPSTREAM', value: 'http://${apiAppName}.internal.${environmentDefaultDomain}' }
          ]
        }
      ]
      scale: {
